...
function parseCourse(str) {
  ...
  switch (ret1.length) {
    case 6:
      infos.position = ret1[3]
      break;
    case 5:
      infos.position = ret1[2]
      break;
    default:
      infos.position = '无地点'
  }
...
// parseCourse('大学英语①（2017） [4-18]周 单周 1-2节 20本25班 3－203 210 讲授')
...
// parseCourse('高等数学（乙）① （2017） [4-18]周 6-8节 3－202 68 讲授')